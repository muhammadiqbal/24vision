...
class DistanceController extends AppBaseController
{
    ...
    public function store(CreateDistanceRequest $request)
    {
        ...
        $script = 'source activate laraenv && python3 /var/www/24vision/PyTools/DistanceCalculator.py '.$startPort->id.' '.$endPort->id.' '.$startPort->latitude.' '.$startPort->longitude.' '.$endPort->latitude.' '.$endPort->longitude;
