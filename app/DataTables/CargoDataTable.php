...
class CargoDataTable extends DataTable
{
    ...
    public function query()
    {
        ...
        $cargos = Cargo::leftjoin('cargo_status', 'cargo_status.id','cargos.status_id')
                        ...
                        ->leftjoin('loading_discharging_rate_types as load_type', 'cargos.loading_rate_type','load_type.id')
                        ->leftjoin('loading_discharging_rate_types as disch_type', 'cargos.discharging_rate_type','disch_port.id')
