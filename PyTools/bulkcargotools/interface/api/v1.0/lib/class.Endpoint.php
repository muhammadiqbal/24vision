<?php
/*
This class represents a REST endpoint that is capable of handling API requests. Use the generic "call" function. That calls - internally - the various specific get/post/... functions. These are designed to be overridden. 
*/
class Endpoint {
