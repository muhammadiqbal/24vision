...
if (!is_allowed($_SERVER['PHP_AUTH_USER'], $GLOBALS["INPUT_PARAMS"]["type"], $_SERVER['REQUEST_METHOD'])) {
	sendReturnCode(403);
	echo "You are not authorized to use this endpoint, request method or combination thereof.";
	exit;
}
...
//Create instance of the API object, create the Endpoint object from it 
$api = new API;
$endpoint = null;
